...
class ExpDockTrainer(Trainer):
    ...
    def share_step(self, batch, batch_idx, val=False):
        loss, (ot_loss, dock_loss, bind_loss, stable_loss, match_loss, balance_loss, rmsd_loss) = self.model(**batch)
        ...
        self.log(f'Bind Loss/{log_type}', bind_loss, batch_idx, val)
        self.log(f'Stable Loss/{log_type}', stable_loss, batch_idx, val)
        self.log(f'Match Loss/{log_type}', match_loss, batch_idx, val)
        self.log(f'Balance Loss/{log_type}', balance_loss, batch_idx, val)
